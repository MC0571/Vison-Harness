...
Use this entry when a project needs Agent guidance created or corrected. Read the [project-context behavior rules](../../../specs/project-context/spec.md) and [shared operating rules](../../../METHOD.md), then inspect the target project before writing.
