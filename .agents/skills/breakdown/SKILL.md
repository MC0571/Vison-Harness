...
Before acting, read the applicable project rules and the current sources of truth. For Vision Harness behavior, use [the Breakdown specification](../../../specs/breakdown/spec.md); use [METHOD.md](../../../METHOD.md) for shared authorization, evidence, dependency, and completion rules. Do not copy those rules into the output.
