...
Use this entry to form, inspect, or revise a project's long-term vision. Read the project's authoritative facts and the [vision behavior rules](../../references/vision-behavior.md) plus [shared operating rules](../../references/shared-rules.md) before acting. The package's own vision is method material, never a consumer-project decision.
